        ...
        <div className="mt-8 pt-6 border-t border-white/5">
          <div className="flex flex-col items-center gap-3">
            <p className="text-white/30 text-xs font-medium">
              ...
              <span className="text-white/50 font-bold">Mohamed Mubarak</span>
            </p>
            <div className="flex items-center gap-2">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-8 h-8 glass rounded-lg flex items-center justify-center text-white/40 hover:text-[#1877F2] hover:border-[#1877F2]/20 transition-all duration-200"
                aria-label="Facebook - Mohamed Mubarak"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="w-8 h-8 glass rounded-lg flex items-center justify-center text-white/40 hover:text-[#25D366] hover:border-[#25D366]/20 transition-all duration-200"
                aria-label="WhatsApp - Mohamed Mubarak"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="w-8 h-8 glass rounded-lg flex items-center justify-center text-white/40 hover:text-[#0A66C2] hover:border-[#0A66C2]/20 transition-all duration-200"
                aria-label="LinkedIn - Mohamed Mubarak"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="w-8 h-8 glass rounded-lg flex items-center justify-center text-white/40 hover:text-[#E4405F] hover:border-[#E4405F]/20 transition-all duration-200"
                aria-label="Instagram - Mohamed Mubarak"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
